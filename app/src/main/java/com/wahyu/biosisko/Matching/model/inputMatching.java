...
public class inputMatching implements Parcelable {
    ...
    protected inputMatching(Parcel in) {
    ...
    public static final Creator<inputMatching> CREATOR = new Creator<inputMatching>() {
        @Override
        public inputMatching createFromParcel(Parcel in) {
            return new inputMatching(in);
        }
        @Override
        public inputMatching[] newArray(int size) {
            return new inputMatching[size];
        }
    };
