...
public class inputCrossword implements Parcelable {
    ...
    protected inputCrossword(Parcel in) {
    ...
    public static final Creator<inputCrossword> CREATOR = new Creator<inputCrossword>() {
        @Override
        public inputCrossword createFromParcel(Parcel in) {
            return new inputCrossword(in);
        }
        @Override
        public inputCrossword[] newArray(int size) {
            return new inputCrossword[size];
        }
    };
